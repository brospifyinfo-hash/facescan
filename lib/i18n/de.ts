...
export const de: Dict = {
  ...
  plans: {
    ...
    pro: {
      ...
      features: [
        ...
        "Persönliche Produktempfehlungen, passend zu deiner Analyse",
  ...
  account: {
    ...
    signedOutBody:
      "Melde dich an — mit E-Mail-Code, Passwort oder Google. Deine Scans und Käufe liegen unter deiner Adresse und bleiben dauerhaft erhalten.",
    signIn: "Anmelden",
    signOut: "Abmelden",
    savedBody:
    ...
    passwordActive: "Passwort ist gesetzt. Du kannst dich damit oder mit dem E-Mail-Code anmelden.",
    passwordNone: "Kein Passwort gesetzt — du meldest dich mit dem E-Mail-Code an.",
