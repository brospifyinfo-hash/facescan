...
export const fr: Dict = {
  ...
  landing: {
    ...
    trustPayment: "Paiement traité par Stripe",
    trustOnce: "Paiement unique · sans abonnement",
    trustEncrypted: "Connexion chiffrée",
    trustGermany: "Éditeur basé en Allemagne",
  ...
  plans: {
    raw: {
      ...
      tagline: "Analyse et recommandations produits",
      features: [
        "L'analyse générale de ton visage",
        "Les 15 mesures avec leur plage de référence",
        "Tes points forts et tes axes de progrès",
        "Recommandations produits avec lien direct",
      ],
      excluded: [
        "Plan glow-up",
        "Plan de 4 semaines et studio coiffure",
        "Image de résultat et analyse IA approfondie",
      ],
    },
    pro: {
      name: "Analyse Pro",
      tagline: "Tout le socle plus le plan glow-up",
      features: [
        "Tout ce que contient l'analyse de base",
        "Plan glow-up — ton plan d'action personnel",
        "Historique de tes scans dans ton compte",
      ],
      excluded: [
        "Plan de 4 semaines",
        "Studio coiffure et image de résultat",
        "Analyse IA approfondie et export PDF",
      ],
    },
    blueprint: {
      name: "The Blueprint",
      ...
      features: [
        ...
        "Plan de 4 semaines, semaine après semaine",
        "Studio coiffure adapté à ton visage",
        "Ton image de résultat — à quoi tu pourrais ressembler",
        "Analyse IA approfondie en document + export PDF",
      ],
      excluded: [],
    },
  },
  ...
  pay: {
    ...
    errors: {
      ...
      accountExists: "Un compte existe déjà pour cette adresse. Connecte-toi en haut à droite : ton achat rejoindra les précédents.",
      emailNeeded: "Saisis une adresse e-mail valide.",
