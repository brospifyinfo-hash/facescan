...
export const fr: Dict = {
  ...
  account: {
    ...
    loading: "Chargement…",
    signedOutBody:
      "Connecte-toi — avec le code par e-mail, un mot de passe ou Google. Tes scans et tes achats restent sous ton adresse.",
    signIn: "Se connecter",
    ...
    passwordActive: "Mot de passe défini. Connecte-toi avec lui ou avec le code par e-mail.",
    passwordNone: "Pas de mot de passe — tu te connectes avec le code par e-mail.",
