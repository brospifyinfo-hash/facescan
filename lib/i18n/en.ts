...
export const en: Dict = {
  ...
  plans: {
    raw: {
      name: "Base analysis",
      tagline: "Analysis plus product recommendations",
      features: [
        "The general analysis of your face",
        "All 15 measurements with reference range",
        "Your strengths & areas to work on",
        "Product recommendations with a direct link",
      ],
      excluded: [
        "Glow-up plan",
        "Four-week plan & hairstyle studio",
        "Result image & AI deep-dive",
      ],
    },
    pro: {
      name: "Analysis Pro",
      tagline: "Everything in Base plus the glow-up plan",
      features: [
        "Everything in the base analysis",
      ...
      excluded: [
        ...
        "AI deep-dive & PDF export",
      ],
    },
    blueprint: {
      name: "The Blueprint",
      tagline: "All of it: plans, hairstyle, result image",
      features: [
        "Everything in Base & Pro",
        "Four-week plan, week by week",
        "Hairstyle studio for your face shape",
        "Your result image — how you could look",
        "AI deep-dive as a document + PDF export",
      ],
      excluded: [],
    },
  },
