...
export const en: Dict = {
  ...
  account: {
    ...
    loading: "Loading…",
    signedOutBody:
      "Sign in — with the email code, a password or Google. Your scans and purchases live under your address and stay there.",
    signIn: "Sign in",
    signOut: "Sign out",
    savedBody:
    ...
    passwordActive: "Password is set. Sign in with it or with the email code.",
    passwordNone: "No password set — you sign in with the email code.",
