...
export const es: Dict = {
  ...
  plans: {
    raw: {
      ...
      tagline: "Análisis y recomendaciones de producto",
      features: [
        "El análisis general de tu rostro",
        "Las 15 medidas con su rango de referencia",
        "Tus puntos fuertes y a mejorar",
        "Recomendaciones de producto con enlace directo",
      ],
      excluded: [
        "Plan glow-up",
        "Plan de 4 semanas y estudio de peinados",
        "Imagen de resultado y análisis profundo con IA",
      ],
    },
    pro: {
      name: "Análisis Pro",
      tagline: "Todo lo básico más el plan glow-up",
      features: [
        "Todo el análisis básico",
        "Plan glow-up — tu plan de acción personal",
        "Historial de escaneos en tu cuenta",
      ],
      excluded: [
        "Plan de 4 semanas",
        "Estudio de peinados e imagen de resultado",
        "Análisis profundo con IA y exportación PDF",
      ],
    },
    blueprint: {
      name: "The Blueprint",
      ...
      features: [
        "Todo lo de Básico y Pro",
        "Plan de 4 semanas, semana a semana",
        "Estudio de peinados para tu tipo de rostro",
        "Tu imagen de resultado — cómo podrías verte",
        "Análisis profundo con IA en documento + PDF",
      ],
      excluded: [],
    },
  },
  ...
  upload: {
    ...
    ageConfirm: "Tengo al menos 18 años.",
